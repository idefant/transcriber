...
Никогда не добавляй в сообщение коммита пометку о соавторстве агента, например `Co-Authored-By: Claude ... <noreply@anthropic.com>`, и любые другие подписи вида «сгенерировано ассистентом». Сообщение коммита должно содержать только описание изменения.
...
- Для выбора режима работы и передачи задач между агентами следуй [docs/agent/multi-agent-workflow.md](docs/agent/multi-agent-workflow.md). Не привлекай дополнительных агентов для изолированных задач с низким риском.
