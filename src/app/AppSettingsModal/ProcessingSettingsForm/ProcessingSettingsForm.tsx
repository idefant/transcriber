...
const ProcessingSettingsForm: FC<ProcessingSettingsFormProps> = ({ disabled = false, task }) => {
  ...
  return (
    <Form className={styles.form} disabled={disabled} layout="vertical">
      <SettingsSection compact title={t('settings.processing.sections.model')}>
      ...
      <SettingsSection compact title={t('settings.processing.sections.prompts')}>
        <Form.Item>
          <div className={styles.switchRow}>
